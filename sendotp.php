...
if ($err== false) {
	echo '<div class="msg1789">'."<font color='green'>"."SENDING OTP TO YOUR MOBILE NUMBER PLEASE WAIT...."."</font>".'</div>';
	 header("refresh:3;url=verifyotp.html");
  
} else {
	
	echo '<div class="msg1789">'."<font color='red'>"."cURL Error #:" . $err."</font>".'</div>';
 header("refresh:4;url=citizenregister.html");
}
?>
