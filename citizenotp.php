...
if ($err== false) {
	echo '<div class="msg1719">'."<font color='green'>"."SENDING OTP TO YOUR MOBILE NUMBER PLEASE WAIT...."."</font>".'</div>';
	 header("refresh:3;url=citizenotpverify.html");
  
} else {
	
	echo '<div class="msg1719">'."<font color='red'>"."cURL Error #:" . $err."</font>".'</div>';
